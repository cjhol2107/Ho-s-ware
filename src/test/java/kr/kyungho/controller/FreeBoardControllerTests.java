...
public class FreeBoardControllerTests {
	...
	public void testRegister() throws Exception {
		...
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/freeBoard/register")
				.param("title", "테스트 새글 제목50")
				.param("content", "테스트 새글 내용50")
				.param("writer", "user50"))
	...
	public void testModify() throws Exception {
		...
		String resultPage = mockMvc
				.perform(MockMvcRequestBuilders.post("/freeBoard/modify").param("bno", "1").param("title", "수정된 테스트 새글 제목")
