...
<body>
	<div class="row">
		<div class="col-lg-12">
			<h4 class="page-header">받은 쪽지함</h4>
			<b><fmt:formatNumber value="${getCount.unreadRcvMailCnt}" type="number"/> / 
			<fmt:formatNumber value="${getCount.rcvMailCnt}" type="number"/></b>
					...
					<table class="table table-hover" id="dataTables-example" style="margin-bottom:0px;">
						<thead>
							<tr>
								...
								<th class="text-center" style="width:180px">읽음</th>
								<th>제목</th>
	...
	<!-- /.row -->
		...
		<form id='actionForm' name="mail_received" action="/mail/getReceived" method='get'>
			<input type='hidden' name='result' value='<c:out value="${result}"/>'> 
			<input type='hidden' name='pageNum' value='${pageMaker.cri.pageNum }'> 
			<input type='hidden' name='amount' value='${pageMaker.cri.amount }'> 
			<input type='hidden' name='type' value='${pageMaker.cri.type }'>
			<input type='hidden' name='keyword' value='${pageMaker.cri.keyword }'>
			<input type='hidden' name='unread' value='${getCount.unreadRcvMailCnt}'>
			<input type='hidden' name='total' value='${getCount.rcvMailCnt}'>
