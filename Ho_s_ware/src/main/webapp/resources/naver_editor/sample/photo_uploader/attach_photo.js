    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/freeBoard/multiplePhotoUpload;' 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/freeBoard/file_uploader',	//html5 지원불가 버전 
 	        sCallback : '/resource/naver_editor/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
